 ...
 * @author Personal
 */
public class AgregarInst extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CorreoInstitucional");

        jScrollPane6.setViewportView(jTextPane6);

        jLabel6.setText("Número de Estudiantes");
    ...
    String correo = jTextPane5.getText();
    ...
    if (!correo.matches("\\b[\\w.%-]+@[-.\\w]+\\.[A-Za-z]{2,4}\\b")) {
        ...
        try {
            ...
            int idAsignado = objDAO.RegistrarInst(nombre, dep, ciudad, numero, tel, correo);
            JOptionPane.showMessageDialog(this, "Institución registrada con éxito. ID asignado: " + idAsignado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarInst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarInst().setVisible(true);
            }
        });
    }
